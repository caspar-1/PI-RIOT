 ...
 * @{
 */
#define MRF24J40_RXMCR_NOACKRSP                 (0x20)//(0x20)
#define MRF24J40_RXMCR_PANCOORD                 (0x08)//(0x08)
#define MRF24J40_RXMCR_COORD                    (0x04)//(0x04)
#define MRF24J40_RXMCR_ERRPKT                   (0x02)//(0x02)
#define MRF24J40_RXMCR_PROMI                    (0x01)//(0x01)
/** @} */
 ...
 * @{
 */
#define MRF24J40_RXFLUSH_WAKEPOL                (0x40)//(0x40)
#define MRF24J40_RXFLUSH_WAKEPAD                (0x20)//(0x20)
#define MRF24J40_RXFLUSH_CMDONLY                (0x80)//(0x08)
#define MRF24J40_RXFLUSH_DATAONLY               (0x40)//(0x04)
#define MRF24J40_RXFLUSH_BCNONLY                (0x20)//(0x02)
#define MRF24J40_RXFLUSH_RXFLUSH                (0x01)//(0x01)
/** @} */
...
#define MRF24J40_TXMCR_MACMINBE                 (0x18)//(0b00011000)
#define MRF24J40_TXMCR_NOCSMA                   (0x80)//(0x80)
#define MRF24J40_TXMCR_BATLIFEXT                (0x40)//(0x40)
#define MRF24J40_TXMCR_SLOTTED                  (0x20)//(0x20)
#define MRF24J40_TXMCR_MACMINBE1                (0x10)//(0x10)
#define MRF24J40_TXMCR_MACMINBE0                (0x08)//(0x08)
#define MRF24J40_TXMCR_CSMABF2                  (0x04)//(0x04)
#define MRF24J40_TXMCR_CSMABF1                  (0x20)//(0x02)
#define MRF24J40_TXMCR_CSMABF0                  (0x01)//(0x01)
